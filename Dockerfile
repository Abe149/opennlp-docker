...
RUN curl -o                                  $workdir/apache-opennlp-1.9.3-bin.zip \
         http://apache.claz.org/opennlp/opennlp-1.9.3/apache-opennlp-1.9.3-bin.zip
...
RUN unzip apache-opennlp-1.9.3-bin.zip
RUN rm    apache-opennlp-1.9.3-bin.zip
RUN mv    apache-opennlp-1.9.3/        /usr/bin/

ENTRYPOINT ["/usr/bin/apache-opennlp-1.9.3/bin/opennlp"]
